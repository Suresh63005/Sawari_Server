...
const PackagePrice = sequelize.define("PackagePrice", {
  ...
  base_fare: {
    ...
    allowNull: false,
    comment: "Base fare (price) for the package, sub-package, and car combination, e.g., 150.00",
  },
  description: {
  ...
  status: {
    ...
    defaultValue: true,
    comment: "Indicates if the package price is active (true) or inactive (false)",
  },
}, {
