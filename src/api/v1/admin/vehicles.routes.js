...
router.get(endPoints.vehicles.getAllVehicles, authMiddleware, vehicleController.getAllVehicles);
router.post(endPoints.vehicles.approveVehicle, authMiddleware, vehicleController.approveVehicle);
