...
describe("Ticket API Integration Tests", () => {
    ...
    describe("POST /api/v1/mobile/ticket/create", () => {
        jest.mock("../../../src/services/ticket.service", () => {
            const originalModule = jest.requireActual("../../../src/services/ticket.service");
            return {
                ...originalModule,
                uploadToS3: jest.fn().mockImplementation((files, folder) => {
                    return files.map(
                        (file) => `https://innoitlabs.s3.ap-south-1.amazonaws.com/${folder}/${Date.now()}-${file.filename}`
                    );
                }),
            };
        });
        ...
        it("should create a ticket successfully with valid data and image", async () => {
            ...
            console.log("Create ticket response:", JSON.stringify(response.body, null, 2));
            ...
            expect(response.body.data).toMatchObject({
                ...
                status: "open",
                raised_by: driver.id,
                images: expect.stringMatching(/^"https:\/\/innoitlabs\.s3\.ap-south-1\.amazonaws\.com\/ticket-images\//),
            });
        ...
        it("should return 400 if title is missing", async () => {
            ...
            console.log("Missing title response:", JSON.stringify(response.body, null, 2));

            expect(response.status).toBe(400);
            expect(response.body.sucess).toBe(false);
            expect(response.body.message).toContain("Title, description, are required");
        });
        ...
        it("should return 400 if description is missing", async () => {
            ...
            console.log("Missing description response:", JSON.stringify(response.body, null, 2));
        ...
        it("should return 400 if priority is invalid", async () => {
            ...
            console.log("Invalid priority response:", JSON.stringify(response.body, null, 2));
        ...
        it("should create a ticket with no images (null images field)", async () => {
            ...
            console.log("No images response:", JSON.stringify(response.body, null, 2));
        ...
        it("should handle multiple image uploads", async () => {
            ...
            console.log("Multiple images response:", JSON.stringify(response.body, null, 2));
            ...
            expect(JSON.parse(response.body.data.images)).toEqual(
                expect.arrayContaining([
                    expect.stringMatching(/^https:\/\/innoitlabs\.s3\.ap-south-1\.amazonaws\.com\/ticket-images\//),
                    expect.stringMatching(/^https:\/\/innoitlabs\.s3\.ap-south-1\.amazonaws\.com\/ticket-images\//),
                ])
            );
        });
        ...
        it("should handle edge case: long description", async () => {
            ...
            console.log("Long description response:", JSON.stringify(response.body, null, 2));
    ...
    describe("GET /api/v1/mobile/ticket", () => {
        ...
        it("should return tickets successfully for an authenticated driver", async () => {
            await Ticket.create({
                ...
                status: "open",
                images: JSON.stringify("https://innoitlabs.s3.ap-south-1.amazonaws.com/ticket-images/image1.jpg"),
                priority: "medium",
                createdAt: new Date(),
                updatedAt: new Date(),
            });
            ...
            await Ticket.create({
                ...
                status: "closed",
                images: JSON.stringify("https://innoitlabs.s3.ap-south-1.amazonaws.com/ticket-images/image2.jpg"),
                priority: "medium",
                createdAt: new Date(),
                updatedAt: new Date(),
            });
            ...
            console.log("Tickets before GET:", JSON.stringify(ticketsBefore, null, 2));
            ...
            expect(response.body.data[0].images).toBe("https://innoitlabs.s3.ap-south-1.amazonaws.com/ticket-images/image2.jpg");
            expect(response.body.data[1]).toHaveProperty("title", "Test Ticket 1");
            expect(response.body.data[1].images).toBe("https://innoitlabs.s3.ap-south-1.amazonaws.com/ticket-images/image1.jpg");
        });
        ...
        it("should handle no tickets gracefully", async () => {
            ...
            console.log("No tickets response:", JSON.stringify(response.body, null, 2));
        ...
        it("should handle malformed images field gracefully", async () => {
            ...
            const ticketsBefore = await Ticket.findAll({ raw: true });
            console.log("Tickets before GET (malformed):", JSON.stringify(ticketsBefore, null, 2));
            ...
            console.log("Malformed images response:", JSON.stringify(response.body, null, 2));
        ...
        it("should handle null images field", async () => {
            ...
            const ticketsBefore = await Ticket.findAll({ raw: true });
            console.log("Tickets before GET (null):", JSON.stringify(ticketsBefore, null, 2));
            ...
            console.log("Null images response:", JSON.stringify(response.body, null, 2));
        ...
        it("should return 500 if database query fails", async () => {
            const findAllSpy = jest.spyOn(Ticket, "findAll").mockRejectedValue(new Error("Database error"));
            ...
            console.log("Database error response:", JSON.stringify(response.body, null, 2));

            expect(response.status).toBe(500);
            expect(response.body.message).toBe("Error fetching tickets: Database error");
        ...
        it("should handle edge case: double-stringified images JSON", async () => {
            ...
            try {
                ...
                console.log("Stored images (double-stringified):", doubleStringifiedImages);
            } catch (error) {
            ...
            const ticketsBefore = await Ticket.findAll({ raw: true });
            console.log("Tickets before GET (double-stringified):", JSON.stringify(ticketsBefore, null, 2));
            ...
            console.log("Double-stringified response:", JSON.stringify(response.body, null, 2));

            expect(response.status).toBe(200);
            expect(response.body.success).toBe(true);
            expect(response.body.message).toBe("Ticket fetched sucessfully");
            expect(response.body.data).toHaveLength(1);
            expect(response.body.data[0].images).toBe("https://innoitlabs.s3.ap-south-1.amazonaws.com/ticket-images/image3.jpg");
        });
        ...
        it("should handle edge case: empty images array", async () => {
            ...
            const ticketsBefore = await Ticket.findAll({ raw: true });
            console.log("Tickets before GET (empty images):", JSON.stringify(ticketsBefore, null, 2));
            ...
            console.log("Empty images response:", JSON.stringify(response.body, null, 2));
        ...
        it("should return tickets in descending order of createdAt", async () => {
            ...
            const ticketsBefore = await Ticket.findAll({ raw: true });
            console.log("Tickets before GET (descending):", JSON.stringify(ticketsBefore, null, 2));
            ...
            console.log("Descending order response:", JSON.stringify(response.body, null, 2));
    ...
    describe("GET /api/v1/mobile/ticket/:id", () => {
        ...
        it("should return a ticket successfully for an authenticated driver with valid ID", async () => {
            ...
            console.log("Valid ticket response:", JSON.stringify(response.body, null, 2));
            ...
            expect(response.body.data).toMatchObject({
                ...
                priority: "medium",
                raised_by: driver.id,
                images: ["https://innoitlabs.s3.ap-south-1.amazonaws.com/ticket-images/image1.jpg"],
            });
            expect(response.body.data.createdAt).toBeDefined();
            expect(response.body.data.updatedAt).toBeDefined();
        });
        ...
        it("should return null data if ticket not found or not owned by driver", async () => {
            ...
            console.log("Non-existent ticket response:", JSON.stringify(response.body, null, 2));
        ...
        it("should handle edge case: double-stringified images JSON", async () => {
            const doubleStringifiedTicket = await Ticket.create({
                ...
                description: "Ticket with double-stringified images",
                status: "open",
                images: JSON.stringify(JSON.stringify(["https://innoitlabs.s3.ap-south-1.amazonaws.com/ticket-images/image2.jpg"])),
                priority: "medium",
                createdAt: new Date(),
                updatedAt: new Date(),
            });
            ...
            console.log("Double-stringified images response:", JSON.stringify(response.body, null, 2));
            ...
            expect(response.body.data).toMatchObject({
                ...
                ticket_number: "000002",
                title: "Double Stringified Ticket",
                images: "[\"https://innoitlabs.s3.ap-south-1.amazonaws.com/ticket-images/image2.jpg\"]", // Updated to stringified
            });
        });
        ...
        it("should return 500 if database query fails", async () => {
            jest.spyOn(Ticket, "findOne").mockRejectedValue(new Error("Database error"));
            ...
            expect(response.status).toBe(500);
            expect(response.body.success).toBe(false);
            expect(response.body.message).toBe("Error fetching ticket: Database error");
